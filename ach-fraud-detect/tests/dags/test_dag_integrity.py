...
def test_dashboard_uses_plugin_api_prefix():
    """The dashboard must call the /fraud-dashboard API routes mounted by the plugin."""
    html = open("plugins/fraud_dashboard.html", encoding="utf-8").read()
    assert 'const API = "/fraud-dashboard";' in html
